...
// --- Dane mockowe (testowe — zostaną zastąpione przez GET /api/applications) ---
const MOCK_APPLICATIONS: Application[] = [
  {
    id: 'W/2026/001',
    childName: 'XYZ1 XYZ1',
    childPesel: '23040500001',
    childBirthDate: '2023-04-05',
    parentName: 'XYZ1 Rodzic1',
    parentPhone: '600 000 001',
    parentEmail: 'xyz1@test.pl',
    address: 'ul. Testowa 1, 32-020 Biskupice',
