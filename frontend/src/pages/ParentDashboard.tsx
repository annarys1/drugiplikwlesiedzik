    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col gap-4">
          ...
          <div>
            <h2 className="font-semibold text-gray-800">Moje wnioski</h2>
            <p className="text-sm text-gray-500 mt-1">Sprawdź status złożonych wniosków rekrutacyjnych oraz ich punktację.</p>
          </div>
          <button
            onClick={() => navigate('/panel/rodzic/moje-wnioski')}
